...
//re10.cieve an artist array, recieve a number
...
console.log(addArtist(artists,'Tasha Ruth','1991-Present day','Full Stack Development','White','lorem ipsum'));
...
function artistInfo(array,string){
 ...
 console.log(artistInfo(artists,'Kazimir Severinovich Malevich'));
